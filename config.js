...
module.exports = {
    ...
    OWN: process.env.OWN === undefined ? '6797309646' : process.env.OWN,
    OWN2: process.env.OWN2 === undefined ? '27619450119' : process.env.OWN2,
    OWN3: process.env.OWN3 === undefined ? '918618971837' : process.env.OWN3,
    OWN4: process.env.OWN4 === undefined ? '27745606434' : process.env.OWN4,
    OWN5: process.env.OWN5 === undefined ? '14242862656' : process.env.OWN5,
